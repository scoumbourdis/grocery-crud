<?php
	...
	$config['grocery_crud_default_text_editor'] = 'ckeditor'; //You can choose 'ckeditor','tinymce' or 'markitup'
	$config['grocery_crud_text_editor_type'] 	= 'minimal'; //You can choose 'minimal' or 'full'

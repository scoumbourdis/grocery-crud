	...
	public function get_field_types()
	{
		...
		if(!empty($this->relation_n_n))
		{
			foreach($this->relation_n_n as $field_name => $field_extras)
			{
				...
				$field_info->required	= isset($this->required_fields) && !empty($this->required_fields) && in_array($field_name,$this->required_fields) ? true : false;;
				$field_info->display_as =
...
class grocery_CRUD_Layout extends grocery_CRUD_Model_Driver
{
	...
	protected function get_layout()
	{
		...
		if($this->echo_and_die === false)
		{
            ...
            // ------------------------------------------
            // already defined in the adminPanel pages
            // ------------------------------------------
					//'base_url'				 	=> base_url()
			);
